...
POOLING_SIZE = 2
POOLING_STRIDE = 2
FINAL_DIMENSION = 2 # label length
...
FULLY_CONNECT_ARRAY_LEN = L2_FILTER_NUM * L2_FILTER_OUTPUT_SIZE_AFTER_POOLING ** 2
FULLY_CONNECT_WEIGHTS = fully_connect_weights(FINAL_DIMENSION, FULLY_CONNECT_ARRAY_LEN)

FULLY_CONNECT_THRESHOLDS = np.zeros(FINAL_DIMENSION)
